...
const Storage = (() => {
  ...
  function rowToStudent(r) {
    return {
      ...
      nisn: r.nisn,
      nis: r.nis || "",
      siswaNik: r.siswa_nik || "",
      siswaTempatLahir: r.siswa_tempat_lahir || "",
      siswaTanggalLahir: r.siswa_tanggal_lahir || "",
      jenisKelamin: r.jenis_kelamin || "",
      jumlahSaudara: r.jumlah_saudara || "",
      anakKe: r.anak_ke || "",
      asal_sekolah: r.asal_sekolah,
      kelas_paralel: r.kelas_paralel,
      emisStatus: r.emis_status,
      nisnIssueStatus: r.nisn_issue_status || "",

      kk: r.kk || "",
      kepalaKeluarga: r.kepala_keluarga || "",

      fatherName: r.father_name || "",
      fatherStatus: r.father_status || "",
      fatherNik: r.father_nik || "",
      fatherBirthplace: r.father_birthplace || "",
      fatherBirthdate: r.father_birthdate || "",
      fatherEducation: r.father_education || "",
      fatherJob: r.father_job || "",
      fatherPhone: r.father_phone || r.phone || "",
      fatherIncomeCategory: r.father_income_category ?? null,
      fatherIncomeRange: r.father_income_range || "",

      motherName: r.mother_name || "",
      motherStatus: r.mother_status || "",
      motherNik: r.mother_nik || "",
      motherBirthplace: r.mother_birthplace || "",
      motherBirthdate: r.mother_birthdate || "",
      motherEducation: r.mother_education || "",
      motherJob: r.mother_job || "",
      motherPhone: r.mother_phone || "",
      motherIncomeCategory: r.mother_income_category ?? null,
      motherIncomeRange: r.mother_income_range || "",

      avgIncomeCategory: r.avg_income_category ?? null,
      avgIncomeRange: r.avg_income_range || "",
  ...
  function studentToRow(s) {
    return {
      ...
      nisn: s.nisn,
      nis: s.nis || "",
      siswa_nik: s.siswaNik || "",
      siswa_tempat_lahir: s.siswaTempatLahir || "",
      siswa_tanggal_lahir: s.siswaTanggalLahir || "",
      ...
      nisn_issue_status: s.nisnIssueStatus || "",

      kk: s.kk || "",
      kepala_keluarga: s.kepalaKeluarga || "",

      father_name: s.fatherName || "",
      father_status: s.fatherStatus || "",
      father_nik: s.fatherNik || "",
      father_birthplace: s.fatherBirthplace || "",
      father_birthdate: s.fatherBirthdate || "",
      father_education: s.fatherEducation || "",
      father_job: s.fatherJob || "",
      father_phone: s.fatherPhone || s.phone || "",
      father_income_category: s.fatherIncomeCategory ?? null,
      father_income_range: s.fatherIncomeRange || "",

      mother_name: s.motherName || "",
      mother_status: s.motherStatus || "",
      mother_nik: s.motherNik || "",
      mother_birthplace: s.motherBirthplace || "",
      mother_birthdate: s.motherBirthdate || "",
      mother_education: s.motherEducation || "",
      mother_job: s.motherJob || "",
      mother_phone: s.motherPhone || "",
      mother_income_category: s.motherIncomeCategory ?? null,
      mother_income_range: s.motherIncomeRange || "",

      avg_income_category: s.avgIncomeCategory ?? null,
      avg_income_range: s.avgIncomeRange || "",

      // Legacy column, kept in sync with fatherPhone for backward compatibility.
