...
const ExcelModule = (() => {
  ...
  const COL = {
    ...
    nis: "siswa_nis",
    siswaNik: "siswa_nik",
    siswaTempatLahir: "siswa_tempatlahir",
    siswaTanggalLahir: "siswa_tanggallahir",
  ...
  function mapRowToStudent(row, existingStatusMap) {
    ...
    return {
      ...
      siswaTempatLahir: Utils.clean(row[COL.siswaTempatLahir]),
      siswaTanggalLahir: Utils.clean(row[COL.siswaTanggalLahir]),
